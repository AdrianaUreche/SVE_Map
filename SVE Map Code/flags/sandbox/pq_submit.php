...
//		echo "The file ". basename( $_FILES["answerfile"]["name"]). " has been uploaded.";
		...
		if ($id==0) {
			...
			$mail->AddAddress("sweet@1630capistrano.com");
			$mail->AddAddress("chris.b.cic@gmail.com");
                        $mail->AddAddress("freya.wolles@gmail.com");
			$mail->AddAddress("elizabethcallens@gmail.com");
			$mail->AddAddress("danny.lousberg@gmail.com");
