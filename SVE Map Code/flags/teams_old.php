...
//		{
		...
		if ($status==1)
		{
			printf("<a href='abandon.php?id=%s&type=%s'>",$id,$type);
			...
			$enda = "</a>";
			printf("<a href='abandon.php?id=%s&type=%s' %s>",$id,$type,$onclickstring);
		}
		printf("<img alt='%s' title='%s' src='%s' height=40 width=40 align=right>%s", $statypes[$status], $statypes[$status], $stat_icon, $enda);
//	}
//		else
//		{
