...
<div id="transbox">
    <div class="post">
        ...
        <div class="button2">
            <a href="puzzle_flying_text.pdf"><font color="red" style="background-color:powderblue;" style="font-size:14px"><b>(Click here to download if you can't view the PDF below)</b></font></a>
        </div>

        <p><embed src="puzzle_flying_text.pdf" width="800px" height="1100px" /></p>
    </div>
</div>
